...
fn synth_ft8_i16(call1: &str, call2: &str, report: &str, freq_hz: f32) -> Vec<i16> {
    ...
    let wave = mfsk_core::engine::tx::synthesize_i16::<mfsk_core::ft8::Ft8>(
        &tones, 12_000, freq_hz, 8_000,
    );
...
fn the_callback_is_not_ft8_only_any_more() {
    ...
    let wave =
        mfsk_core::engine::tx::synthesize_i16::<mfsk_core::ft4::Ft4>(&tones, 12_000, 1500.0, 8_000);
