...
//! `ft8` is always built — it is what a board with no feature flags
//! boots into, and what every mode that is not one of the other three
//! falls back to. The rest are behind default-off cargo features — see `Cargo.toml`'s
